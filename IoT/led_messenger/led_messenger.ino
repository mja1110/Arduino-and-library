...
#define relayPin D0                   //declare the relay pin
#define WLAN_SSID "Anderson"          //enter your WiFi network name within the double quotes & 
#define WLAN_PASS "1234567890"          //password here
 
#define AIO_SERVER       "io.adafruit.com"
#define AIO_SERVERPORT   1883               // use 8883 is used for SSL
#define AIO_USERNAME     "TruongLe"       //Username of Adafruit IO (for this click the Golden Key in Adafruit IO Dashboard)
#define AIO_KEY          "45aed57947fe40aab49e28091b9ba9f2"       //key of Adafruit IO (for this click the Golden Key in Adafruit IO Dashboard)
 
WiFiClient client;                                                                                  // Create an ESP8266 WiFiClient class to connect to the MQTT server.
Adafruit_MQTT_Client mqtt(&client, AIO_SERVER, AIO_SERVERPORT, AIO_USERNAME, AIO_KEY);              // Setup the MQTT client class by passing in the WiFi client and MQTT server and login details.
Adafruit_MQTT_Subscribe onoffbutton = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/feeds/led-messenger");  // Setup a feed called 'onoff' for subscribing to changes.
void MQTT_connect();
void setup() 
{
